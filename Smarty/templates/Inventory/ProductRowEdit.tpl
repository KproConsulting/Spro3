...
{foreach key=row_no item=data from=$ASSOCIATEDPRODUCTS name=outer1}
	...
	{assign var="kpRifOrdineCliente" value="kpRifOrdineCliente"|cat:$row_no} {* kpro@tom101220181102 *}
	{assign var="kpDataOrdineCliente" value="kpDataOrdineCliente"|cat:$row_no} {* kpro@tom101220181102 *}
	{assign var="kpCodiceCup" value="kpCodiceCup"|cat:$row_no} {* kpro@tom101220181102 *}
	{assign var="kpCodiceCig" value="kpCodiceCig"|cat:$row_no} {* kpro@tom101220181102 *}
		   ...
		   <tr>
			...
			{/if}
				<td class="small">
					...
					{if $MODULE eq 'Invoice'}
						...
						<table style="width: 100%;">
							<tr>
								...
								<td>
								<td>
									<span style="font-style:italic">Data Ordine Cliente: <b>{$data.$kpDataOrdineCliente}</b></span>
								<td>
							</tr>
							<tr>
								<td>
									<span style="font-style:italic">Codice CUP: <b>{$data.$kpCodiceCup}</b></span>
								<td>
								<td>
									<span style="font-style:italic">Codice CIG: <b>{$data.$kpCodiceCig}</b></span>
								<td>
							</tr>
						</table>
					...
					<input type="hidden" readonly name="kpRifOrdineCliente{$row_no}" id="kpRifOrdineCliente{$row_no}" value="{$data.$kpRifOrdineCliente}">
					<input type="hidden" readonly name="kpDataOrdineCliente{$row_no}" id="kpDataOrdineCliente{$row_no}" value="{$data.$kpDataOrdineCliente}">
					<input type="hidden" readonly name="kpCodiceCup{$row_no}" id="kpCodiceCup{$row_no}" value="{$data.$kpCodiceCup}">
					<input type="hidden" readonly name="kpCodiceCig{$row_no}" id="kpCodiceCig{$row_no}" value="{$data.$kpCodiceCig}">
